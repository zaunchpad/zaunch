...
export function AnonymityMetrics() {
  return (
    <div className="flex flex-col gap-2 sm:gap-3 w-full">
      <div className="bg-neutral-950 border border-gray-800 p-3 sm:p-4 w-full">
         <h3 className="font-rajdhani font-bold text-lg sm:text-xl text-white mb-2 sm:mb-3">Anonymity Set Metrics</h3>
         <div className="border border-gray-800 flex w-full">
             <div className="flex-1 border-r border-gray-800 p-2 sm:p-3 flex flex-col items-center justify-center gap-1">
                 <span className="font-rajdhani text-xs sm:text-sm text-[#79767d] text-center">Total Shielded Value</span>
                 <span className="font-rajdhani font-bold text-base sm:text-lg text-white break-words text-center">42,109 ZEC</span>
             </div>
             <div className="flex-1 p-2 sm:p-3 flex flex-col items-center justify-center gap-1">
                 <span className="font-rajdhani text-xs sm:text-sm text-[#79767d] text-center">Active Tickets</span>
                 <span className="font-rajdhani font-bold text-base sm:text-lg text-white break-words text-center">1,892</span>
             </div>
         </div>
      </div>
      ...
      <div className="bg-[rgba(208,135,0,0.05)] border border-[#d08700] p-3 sm:p-4 flex gap-2 sm:gap-3 items-start">
         ...
         <p className="font-rajdhani font-medium text-[#79767d] text-xs sm:text-sm leading-relaxed">
